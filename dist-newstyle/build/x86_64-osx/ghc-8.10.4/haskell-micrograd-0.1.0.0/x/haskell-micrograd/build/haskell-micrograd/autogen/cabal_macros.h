...
/* package haskell-micrograd-0.1.0.0 */
#ifndef VERSION_haskell_micrograd
#define VERSION_haskell_micrograd "0.1.0.0"
#endif /* VERSION_haskell_micrograd */
#ifndef MIN_VERSION_haskell_micrograd
#define MIN_VERSION_haskell_micrograd(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_micrograd */
...
#define CURRENT_COMPONENT_ID "haskell-micrograd-0.1.0.0-inplace-haskell-micrograd"
